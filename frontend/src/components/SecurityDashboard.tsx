                        ...
                        <div className="p-4 border-b border-slate-800 bg-slate-800/50 flex justify-between items-center">
                            ...
                            <div className="flex bg-slate-900 rounded-lg p-1">
                                <button 
                                    ...
                                    className={`px-2 py-1 text-[8px] font-bold rounded-md transition-colors ${activeTab === 'metrics' ? 'bg-primary-600 text-white' : 'text-slate-400 hover:text-slate-200'}`}
                                >
                                    Metrics
                                </button>
                                <button 
                                    onClick={() => setActiveTab('protocol')}
                                    className={`px-2 py-1 text-[8px] font-bold rounded-md transition-colors ${activeTab === 'protocol' ? 'bg-primary-600 text-white' : 'text-slate-400 hover:text-slate-200'}`}
                                >
                                    Protocol
                                </button>
                                <button 
                                    onClick={() => setActiveTab('mitm')}
                                    className={`px-2 py-1 text-[8px] font-bold rounded-md transition-colors ${activeTab === 'mitm' ? 'bg-red-600 text-white' : 'text-slate-400 hover:text-slate-200'}`}
                                >
                                    MITM
                                </button>
                            </div>
